...
public class MiCalculadora implements WindowListener, ActionListener
{
	...
	double operador1; double operador2;
	int operacion;
	MiCalculadora()
	{
		ventana.setLayout(new GridBagLayout());
		ventana.addWindowListener(this);
		ventana.setSize(270,320);
		...
		// Restrinciones Comunes
		restricciones.fill = GridBagConstraints.BOTH;
		restricciones.weightx = 1.0;
		restricciones.weighty = 1.0;

		// Restrinciones Particulares
